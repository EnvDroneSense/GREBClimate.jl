...
begin
	...
	elseif config_preset == "no_feedbacks"
		...
		log_clouds_dmc = log_vapor_dmc = false
        log_crcl_dmc = log_hydro_dmc = true
        log_atmos_dmc = log_co2_dmc = log_ocean_dmc = log_qflux_dmc = true
        
        log_clouds_drsp = false
        log_crcl_drsp = log_hydro_drsp = true
        log_topo_drsp = log_humid_drsp = true
...
#=╠═╡
if run_benchmarks
	@benchmark circulation!($bench_data.Ta, 8400.0, $bench_data.ws.dTa_crcl, $bench_data.fields, $bench_data.ws, $bench_data.timestate, $bench_data.cfg)
else
	md"*Benchmarks skipped — enable the checkbox above to run.*"
end
  ╠═╡ =#
...
#=╠═╡
if run_benchmarks
	@benchmark circulation!($bench_data.q, 5000.0, $bench_data.ws.dq_crcl, $bench_data.fields, $bench_data.ws, $bench_data.timestate, $bench_data.cfg)
else
	md"*Benchmarks skipped — enable the checkbox above to run.*"
end
  ╠═╡ =#
...
manifest_format = "2.0"
project_hash = "ceb38d0037a30749d50120aea796386be0721476"
